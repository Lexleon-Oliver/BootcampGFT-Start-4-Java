...
//
//        Recentemente, ele teve a ideia de lançar um novo jogo exclusivo de tabuleiro, que ele apelidou de Tabuleiro
//        da Frequência.
//
...
//        respectivamente, o tamanho do tabuleiro e a quantidade de operações. As próximas Q linhas da entrada vão
//        conter as Q operações. O primeiro inteiro de cada linha vai indicar o tipo da operação. Caso seja 1 ou 2,
//        será seguido por mais dois inteiros X (1 ≤ X ≤ N) e R (0 ≤ R ≤ 50). Caso seja 3 ou 4, será seguido por
...
//        você deve imprimir o maior deles. Por exemplo, se uma linha tem os valores [5,7,7,2,5,2,1,3], tanto o 2, 5 e
//        7 se repetem duas vezes, então a resposta será 7, pois é o maior deles.
//
//
